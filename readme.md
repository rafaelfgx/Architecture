...
![](https://github.com/rafaelfgx/Architecture/actions/workflows/build.yml/badge.svg)
![](https://img.shields.io/github/repo-size/rafaelfgx/Architecture)
...
public sealed class CustomerController : ControllerBase
{
    ...
    public Task InactivateAsync(long id) => _customerService.InactivateAsync(id);
