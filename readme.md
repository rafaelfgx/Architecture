...
public sealed class CustomerService : ICustomerService
{
    ...
    public async Task<Result<long>> AddAsync(CustomerModel model)
    {
        var validationResult = new AddCustomerModelValidator().Validation(model);
    ...
    public async Task<Result> UpdateAsync(CustomerModel model)
    {
        var validationResult = new UpdateCustomerModelValidator().Validation(model);
...
{
    public Customer Create(CustomerModel model) => new
    (
        model.Id,
